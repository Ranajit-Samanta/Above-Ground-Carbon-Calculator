...
def save_to_excel():
    ...
    data = {
        ...
        "Wood Density (in kg/cu.m)": [st.session_state.get("A", "N/A")],
        ...
        "Above Ground Biomass (kg)": [st.session_state.get("above_ground_biomass","N/A")],
        "AGB (tones per hectare)": [st.session_state.get("above_ground_biomass_tonnes_per_hectare","N/A")],
        ...
        "Above Ground Carbon (kg)": [st.session_state.get("total_carbon", "N/A")],
...
st.write("<h1 style='color:white; text-align:center; padding: 20px; background-color: black; font-family: Times New Roman, Times, serif; font-style: italic;'>🌳 &emsp;CARBON CALCULATOR &emsp;🌍</h1>", unsafe_allow_html=True)
...
if st.button("Calculate Above Ground Biomass:"):
    try:
        ...
        st.session_state.above_ground_biomass_results = {
            ...
            "Above Ground Biomass.": f"{total_biomass_tones_per_hector} tonnes per hectare"
         }
    except:
    ...
    if st.button("Calculate Carbon"):
        try:
            ...
            st.session_state.carbon_results = {
                ...
                "Above Ground Carbon.": f"{total_carbon_tonnes_per_hectare} tonnes per hectare"
            }
        except:
