...
st.write(f"""
    <div style='color: white; text-align:center; padding: 10px; background-color: #353839; 
    ...
    align-items: center; justify-content: center; gap: 20px;'>
        ...
        <h1 style='margin: 0; font-size: 50px;color: white;'>Unlocking the Tree Carbon Locker</h1>
    </div>
""", unsafe_allow_html=True)
...
with col1:
    ...
    st.write(
        "<h5 style='color: red;'>2.	Enhances Soil Carbon Storage – Root systems and leaf litter contribute to soil organic carbon (SOC), improving soil fertility and carbon retention.</h5>",
        unsafe_allow_html=True,
    )
    st.write(
    ...
    st.write(
        "<h5 style='color: red;'>5.	Reduces Ocean Acidification – By lowering atmospheric CO₂ levels, plant-based sequestration indirectly mitigates ocean acidification, benefiting marine life.</h5>",
        unsafe_allow_html=True,
    )
