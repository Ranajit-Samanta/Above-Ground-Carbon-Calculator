...
def save_to_excel():
    ...
    data = {
        ...
        "Total Biomass": [st.session_state.get("above_ground_biomass_results", {}).get("Above Ground Biomass", "N/A")],
        "Total Biomass tones per hectare": [st.session_state.get("above_ground_biomass_results", {}).get("Above Ground Biomass tonnes per hectare", "N/A")],
        ...
        "Total Carbon tones per hectare": [st.session_state.get("carbon_results", {}).get("Above ground Carbon tonnes per hectare", "N/A")],
...
with col3:
    ...
    if st.session_state.carbon_results:
        ...
        st.write(f"Total Stem Carbon : {total_stem_carbon} kg")
        st.write(f"Total Branch Carbon : {total_branch_carbon} kg")
        st.write(f"Total Leaf Carbon : {total_leaf_carbon} kg")
    ...
    if st.button("Calculate CO2-Equivalent"):
        try:
            ...
            st.session_state.co2_results = {
                ...
                "CO2-Equivalent": f"{co2_equivalent} tonnes per hectare"
