...
def save_to_excel():
    ...
    data = {
        ...
        "No of trees per 100 sq.m": [st.session_state.get("N", "N/A")],
        ...
        "AGB (tonnes per hectare)": [st.session_state.get("above_ground_biomass_tonnes_per_hectare","N/A")],
        ...
        "AGC (tonnes per hectare)": [st.session_state.get("total_carbon_tonnes_per_hectare", "N/A")],
